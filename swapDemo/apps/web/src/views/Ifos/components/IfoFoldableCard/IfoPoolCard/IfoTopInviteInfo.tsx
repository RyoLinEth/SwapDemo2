  ...
  return (
    <>
      ...
      <StyleBox>
        ...
        <Text bold fontSize="14px" color="textSubtle">
          {parentAddress === '0x...' ? 'No Parent Node' : parentAddress}
        </Text>
      </StyleBox>
      <br />
      <StyleBox>
        ...
        >
          {personalLink || 'Please Connect Your Wallet'}
        </Text>
      </StyleBox>
      <br />
      <StyleBox>
        <StyleLabel>
          Available IDO Amount :
      ...
      <br />
      <StyleBox>
        <StyleLabel>Invitation Info</StyleLabel>
